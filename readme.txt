...
Contributors: Benoti
Tags: cookie, law, jquery, notification, compliance, cookie law, cookies, eu cookie law, eu privacy directive, privacy, privacy directive
...
3. Go to settings->Cookie notification.

== Screenshots ==
1. Plugin admin panel screenshot-1.png.
2. Plugin admin panel screenshot-2.png.
3. Display on web screenshot-3.png.

== Changelog ==
= 1.6.2 =
* library update (fontawesome 4.7)
= 1.6.0 =
* libray update (fontawesome 4.4)
* bugfixes
= 1.5.0 =
* Bugfixes for jQuery CookieBar
= 1.1.0 =
